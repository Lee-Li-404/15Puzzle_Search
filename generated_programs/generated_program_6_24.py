...
def heuristic(s: State) -> int:
    ...
    # we have room to increase the overall greediness of the heuristic to reduce generated nodes.
    ...
    overall_weight = 3.3  # Increased from 3.2 to 3.3 to leverage remaining cost_ratio headroom
