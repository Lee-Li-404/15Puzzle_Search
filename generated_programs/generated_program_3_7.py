...
def heuristic(s: State) -> int:
    ...
    # The penalty for an admissible heuristic is usually +2.
    # To make it greedier and further reduce generated nodes, we increase the penalty.
    LINEAR_CONFLICT_PENALTY = 4
    ...
    for r in range(GRID_SIZE):
        ...
        for i in range(len(tiles_in_row_goal)):
            for j in range(i + 1, len(tiles_in_row_goal)):
                ...
                if goal_c1 > goal_c2:
                    dist += LINEAR_CONFLICT_PENALTY # Increased penalty
