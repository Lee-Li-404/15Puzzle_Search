...
def heuristic(s: State) -> int:
    ...
    # The previous best score (0.0007) used lc * 13 and a multiplier of 3.7.
    # We aim to further reduce generated nodes by slightly increasing the linear conflict penalty 
    # to 14 and pushing the overall multiplier up to 3.8. This more aggressive approach 
    # leverages the headroom in cost_ratio (well below 1.80) to prioritize fewer nodes generated.
    base_h = md + lc * 14 + cc
