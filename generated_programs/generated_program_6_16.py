...
def heuristic(s: State) -> int:
    ...
    LINEAR_CONFLICTS = 0
    # Increased WEIGHT from 2.5 to 2.7. The previous best at WEIGHT=2.5 had a cost_ratio=1.531,
    # well below the 1.80 bound. This allows for a greedier heuristic (larger estimates)
    # to further reduce generated nodes, while attempting to stay within the cost_ratio bound.
    # A previous attempt with WEIGHT=2.8 resulted in a slightly worse score (0.0013),
    # suggesting 2.7 is a safer, more incremental step to tune for optimal performance.
    WEIGHT = 2.7 
