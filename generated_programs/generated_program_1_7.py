...
def heuristic(s: State) -> int:
    ...
    # The previous best heuristic used WEIGHT = 1.75, which resulted in a cost_ratio of 1.143.
    # Since 1.143 is well below the 1.80 bound, we can safely increase the weight to make it greedier.
    # A weight of 2.0 is chosen to push for more node reduction while aiming to stay within the 1.80 cost_ratio bound.
    WEIGHT = 2.0
