...
def heuristic(s: State) -> int:
    ...
    # Increment the multiplier from 3.6 (from heuristic_prev1) to 3.7 to be slightly more greedy.
    # This aims to further reduce generated nodes while staying within the cost_ratio bound of 1.80.
