...
def heuristic(s: State) -> int:
    ...
    # This heuristic evolves the current best (score=0.0006, cost=1.776) by 
    # slightly increasing the linear conflict weight and subtly adjusting 
    # the overall weight. The goal is to aggressively penalize linear conflicts 
    # to prune the search space further, while staying within the cost_ratio bound.
    # This specific tuning aims for a better generated_ratio.
