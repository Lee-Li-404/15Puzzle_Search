...
def heuristic(s: State) -> int:
    ...
    # Final overall greedy multiplier, increased from the previous best (3.55).
    # This aggressively targets node reduction while aiming to stay under the cost ratio limit.
    WEIGHT_FACTOR = 3.65
