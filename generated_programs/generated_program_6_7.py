...
def heuristic(s: State) -> int:
    ...
    LINEAR_CONFLICTS = 0
    WEIGHT = 2.5 # Increased weight to make the heuristic greedier, aiming to further reduce nodes generated.
                 # Previous best was 2.2 with cost_ratio=1.408, allowing a more aggressive weighting towards the 1.80 limit.
