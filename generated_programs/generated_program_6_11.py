...
def heuristic(s: State) -> int:
    ...
    LINEAR_CONFLICTS = 0
    # Increased WEIGHT to prioritize reducing generated nodes, given the previous cost_ratio was well below 1.80.
    # The previous best score was 0.0012 with WEIGHT=2.5. Trying 2.7.
    WEIGHT = 2.7 
