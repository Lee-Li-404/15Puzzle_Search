...
def heuristic(s: State) -> int:
    ...
    LINEAR_CONFLICTS = 0
    # Current best score was 0.0012 with WEIGHT=2.5, cost_ratio=1.531.
    # The cost_ratio is well below the 1.80 bound, allowing for a slightly greedier heuristic.
    # Previous attempts with WEIGHT=2.7 (score=0.0018) and WEIGHT=2.8 (score=0.0013) were worse than 2.5.
    # This suggests 2.5 is near the optimum. Trying a slightly increased weight of 2.6
    # as an incremental step to potentially further reduce generated nodes,
    # while acknowledging the non-monotonic behavior observed with 2.7 and 2.8.
    WEIGHT = 2.6
