...
def heuristic(s: State) -> int:
    ...
    LINEAR_CONFLICTS = 0
    # The previous best score was 0.0012 with WEIGHT=2.5 (cost_ratio=1.531).
    # Given the cost_ratio is well below the 1.80 bound, a slight increase in
    # WEIGHT can be attempted to further reduce generated nodes, even if previous
    # larger increments (2.6, 2.7, 2.8) resulted in worse scores, likely due
    # to disproportionate increases in cost_ratio. A smaller increment to 2.55
    # is chosen to be less aggressive and maintain cost_ratio within limits.
    WEIGHT = 2.55 
    ...
    # Each such conflict adds 2 to the heuristic, a standard for non-admissible (and admissible) variants.
