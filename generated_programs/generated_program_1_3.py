...
def heuristic(s: State) -> int:
    ...
    # Since Manhattan Distance + Linear Conflicts (MDLC) is admissible, its cost_ratio is 1.0.
    # A weight of 1.5 should keep the cost_ratio well within the 1.80 bound while significantly
    # reducing generated nodes, as the heuristic does NOT need to be admissible.
    WEIGHT = 1.5
