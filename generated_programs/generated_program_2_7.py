...
def heuristic(s: State) -> int:
    ...
    # The weight for linear conflicts is increased slightly to be more aggressive.
    # The overall multiplier is also adjusted to be greedy but maintain cost_ratio.
