...
def heuristic(s: State) -> int:
    ...
    LINEAR_CONFLICTS = 0
    WEIGHT = 1.7 # Increased weight to make the heuristic greedier, aiming to further reduce nodes generated.
                 # Previous best was 1.4 with cost_ratio=1.143, allowing more aggressive weighting towards 1.80 limit.
